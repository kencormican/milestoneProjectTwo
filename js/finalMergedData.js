...
function writeToDocument() {
  ...
  getData(function (data) {
    ...
    pageElement.innerHTML = `<table>${tableHeaders}${tableRows}</table>`.replace(/,/g, ""); //Table Header & Added and string commas removed 
