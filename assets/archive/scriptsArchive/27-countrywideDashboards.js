...
function setCountryPieChartData(fromAgePieChartCases, fromGenderPieChartCases) {
    ...
    pieChartAgeData = fromAgePieChartCases;  
    pieChartGenderData = fromGenderPieChartCases;
    ...
    google.charts.load("current", {
        packages: ["corechart", "controls"]            // Load Pie Chart package
    });
    ...
    // Declare function to draw Dashboard
    ...
    function drawDashboard() {
        ...
        var dropdownSelecter = new google.visualization.ControlWrapper({
          'controlType': 'CategoryFilter',
          'containerId': 'selecter-iv',
          'options': {
            'filterColumnIndex': 0
            //'values': 'auto'
          }
