...
open source COVID statistics acquired through the GeoHive API Catalogue.  My intent is to use an OpenSource Government Data Set to provide a hypothetical end 
...
Use the Google Charts API to render a COVID 19 Heat Map of Ireland broken down by County Boundary.
